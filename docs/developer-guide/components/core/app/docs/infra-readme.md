    ...
    ingress:
      ...
      tls:
        - hosts:
          ...
          # Secret name must be different to the certificate that is generated by seaweed for it's internal communication.
          # This is specifically for external communications.
          secretName: seaweedfs-main-admin-cert
      annotations:
